...
QT_MOC_LITERAL(4, 24, 7), // "timeout"
QT_MOC_LITERAL(5, 32, 13) // "returnPressed"

    },
    "HostWindow\0message\0\0msg\0timeout\0"
    "returnPressed"
};
...
void HostWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        HostWindow *_t = static_cast<HostWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (HostWindow::*_t)(const QString & , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HostWindow::message)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject HostWindow::staticMetaObject = {
    { &QWinHost::staticMetaObject, qt_meta_stringdata_HostWindow.data,
      qt_meta_data_HostWindow,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void HostWindow::message(const QString & _t1, int _t2)
{
