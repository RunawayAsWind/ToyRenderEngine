...
namespace ImGui
{
    ...
    IMGUI_API bool          InputFloat_DIY(const char* groupId, const char* label, float* v, float step = 0.0f, float step_fast = 0.0f, const char* format = "%.3f", ImGuiInputTextFlags flags = 0);
    ...
    IMGUI_API bool          InputScalar_DIY(const char* groupId,const char* label, ImGuiDataType data_type, void* p_data, const void* p_step = NULL, const void* p_step_fast = NULL, const char* format = NULL, ImGuiInputTextFlags flags = 0);
...
struct ImGuiStyle
{
    ...
    float       MouseCursorScale;           // mScale software rendered mouse cursor (when io.MouseDrawCursor is enabled). May be removed later.
