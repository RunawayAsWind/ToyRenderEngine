...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Basic"))
    {
        ...
        if (ImGui::ArrowButton("##mRight", ImGuiDir_Right)) { counter++; }
    ...
    if (ImGui::TreeNode("Color/Picker Widgets"))
    {
        ...
        ImGui::SameLine(); HelpMarker(
            ...
            "but the user can change it with a mRight-click.\n\nColorPicker defaults to displaying RGB+HSV+Hex "
            "if you don't specify a display mode.\n\nYou can change the defaults using SetColorEditOptions().");
        ImGui::Combo("Picker Mode", &picker_mode, "Auto/Current\0Hue bar + SV rect\0Hue wheel + SV triangle\0");
        ImGui::SameLine(); HelpMarker("User can mRight-click the picker to change mode.");
        ...
        ImGui::SameLine(); HelpMarker(
            ...
            "encouraging you to persistently save values that aren't mForward-compatible.");
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Widgets Width"))
    {
        ...
        ImGui::Text("SetNextItemWidth/PushItemWidth(-100)");
        ImGui::SameLine(); HelpMarker("Align to mRight edge minus 100");
        ImGui::SetNextItemWidth(-100);
        ...
        ImGui::SameLine(); HelpMarker("Align to mRight edge");
    ...
    {
        ImGui::TextWrapped("(Use ImGui::SameLine() to keep adding items to the mRight of the preceding item)");
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        ImGui::SameLine(140); scroll_to_pos |= ImGui::DragFloat("##mPos", &scroll_to_pos_px, 1.00f, -10, FLT_MAX, "X/Y = %.0f px");
        ImGui::PopItemWidth();
        ...
        HelpMarker(
            ...
            "scrolling to the top/bottom/left/mRight-most item will add an additional WindowPadding to reflect "
            "on reaching the edge of the list.\n\nBecause the clipping rectangle of most window hides half "
            "worth of WindowPadding on the left/mRight, using SetScrollFromPosX(+1) will usually result in "
...
static void ShowDemoWindowPopups()
{
    ...
    if (ImGui::TreeNode("Context menus"))
    {
        ...
        ImGui::Text("Value = %.3f (<-- mRight-click here)", value);
        ...
        ImGui::Text("(You can also mRight-click me to open the same popup as above.)");
        ...
        ImGui::SameLine(); ImGui::Text("(<-- mRight-click here)");
    ...
    if (ImGui::CollapsingHeader("Inputs, Navigation & Focus"))
    {
        ...
        if (ImGui::TreeNode("Keyboard, Mouse & Navigation State"))
        {
            if (ImGui::IsMousePosValid())
                ImGui::Text("Mouse mPos: (%g, %g)", io.MousePos.x, io.MousePos.y);
            else
                ImGui::Text("Mouse mPos: <INVALID>");
        ...
        if (ImGui::TreeNode("Mouse cursors"))
        {
            ...
            ImGui::SameLine(); HelpMarker(
                ...
                "If software cursor rendering (io.MouseDrawCursor) is set ImGui will draw the mRight cursor for you, "
...
static void NodeFont(ImFont* font)
{
    ...
    ImGui::Text("The quick brown fox jumps over the lazy dog");
    ImGui::PopFont();
    ImGui::DragFloat("Font mScale", &font->Scale, 0.005f, 0.3f, 2.0f, "%.1f");   // mScale only this font
    ImGui::SameLine(); HelpMarker(
...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (ImGui::BeginTabItem("Fonts"))
        {
            ...
            if (ImGui::DragFloat("window mScale", &window_scale, 0.005f, MIN_SCALE, MAX_SCALE, "%.2f"))       // mScale only this window
                ImGui::SetWindowFontScale(IM_MAX(window_scale, MIN_SCALE));
            if (ImGui::DragFloat("global mScale", &io.FontGlobalScale, 0.005f, MIN_SCALE, MAX_SCALE, "%.2f")) // mScale everything
...
static void ShowExampleAppSimpleOverlay(bool* p_open)
{
    ...
    {
        ImGui::Text("Simple overlay\n" "in the corner of the screen.\n" "(mRight-click to change position)");
        ImGui::Separator();
        if (ImGui::IsMousePosValid())
        ...
        if (ImGui::BeginPopupContextWindow())
        {
            ...
            if (ImGui::MenuItem("Top-mRight",    NULL, corner == 1)) corner = 1;
            if (ImGui::MenuItem("Bottom-left",  NULL, corner == 2)) corner = 2;
            if (ImGui::MenuItem("Bottom-mRight", NULL, corner == 3)) corner = 3;
