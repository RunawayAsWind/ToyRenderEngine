...
class FBXSDK_DLL FbxAnimEvalClassic : public FbxAnimEvaluator
{
	...
	* Transform = mTrans * RotationOffset* RotationPivot* PreRotation * LocalRotation* PostRotation * RotationPivotInverse* ScalingOffset* ScalingPivot* LocalScaling* ScalingPivotInverse
