...
public:
    ...
    /** Apply filter on the given animation curves.
      ...
      * \remarks              The curves are assumed to represent: mTrans X,Y and Z, Rotation X,Y and Z and
    ...
    /** Get the mTrans Rotation Scaling source matrix
    ...
    /** Set the mTrans Rotation Scaling destination matrix.
      * \param pIndex      The matrix ID.
    ...
    /** Set the mTrans limits to be applied during conversion. Only active limits are applied.
