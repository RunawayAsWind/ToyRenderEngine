...
public:
    ...
    //@{
		...
		*/
		...
		/** mScale value of all keys.
		*	\param pMultValue mScale applied on key values.
		*	\return \c true on success, \c false otherwise.
		*/
		virtual bool KeyScaleValue (float pMultValue) = 0;

		/** mScale value and tangent of all keys.
		*	\param pMultValue mScale applied on key values and tangents.
		*	\return \c true on success, \c false otherwise.
		*/
