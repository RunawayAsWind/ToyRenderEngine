...
private:
    ...
    * \return Return true if one of mTrans X/Y/Z is animated, return false if both of mTrans X/Y/Z are not animated.
    ...
    * \param pNode the FBX node to check.
    * \return Return true if one of mScale X/Y/Z is animated, return false if both of mScale X/Y/Z are not animated.
    * \remarks If there is no key on one property, this property is not animated.
    */
